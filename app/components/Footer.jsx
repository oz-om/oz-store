export default function Footer() {
  return (
    <footer className='w-full text-gray-700 bg-gray-100 body-font mt-10'>
      <div className='container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap'>
        ...
        <div className='flex flex-wrap flex-grow mt-10 -mb-10 justify-center text-center md:pl-20 md:mt-0 md:text-left'>
          <div className='w-52 px-4 lg:w-1/4 md:w-1/2'>
